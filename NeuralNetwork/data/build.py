...
import bisect # bisect 是一个二分查找方法, 使用它可以减少搜索 list 元素的时间
import copy
import logging

import torch.utils.data

from NeuralNetwork.utils.comm import get_world_size
from NeuralNetwork.utils.imports import import_file
from NeuralNetwork.utils.miscellaneous import save_labels
...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, is_for_period=False):
    ...
    paths_catalog = import_file(
        "NeuralNetwork.config.paths_catalog", cfg.PATHS_CATALOG, True
    )
