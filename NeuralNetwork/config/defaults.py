...
# -----------------------------------------------------------------------------
_C.INPUT = CN()
# Size of the smallest side of the image during training; 训练集图片最小尺寸
_C.INPUT.MIN_SIZE_TRAIN = (800,)  # (800,)
# Maximum size of the side of the image during training; 训练集图片最大尺寸
_C.INPUT.MAX_SIZE_TRAIN = 1333
# Size of the smallest side of the image during testing; 测试集图片最小尺寸
_C.INPUT.MIN_SIZE_TEST = 800
# Maximum size of the side of the image during testing; 测试集图片最大尺寸
...
# 即1个GPU=16/8=2, 当只有一个GPU的时候使用2, 防止显存不够
...
# This is global, so if we have 8 GPUs and IMS_PER_BATCH = 16, each GPU will
# see 2 images per batch
# 即1个GPU=8/8=1, 当只有一个GPU的时候使用1, 防止显存不够
